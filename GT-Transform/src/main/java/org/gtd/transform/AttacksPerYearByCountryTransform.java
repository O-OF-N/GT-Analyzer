...
public class AttacksPerYearByCountryTransform {
    ...
    public static PCollection<AttacksPerCountryPerYear> transform(PTable<ImmutableBytesWritable, Result> input) {

        PTable<String, Pair<String, AttackDetails>> grouped = input.parallelDo(new GroupFn(),
